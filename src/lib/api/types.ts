...
export type ProgrammeCourse = {
  ...
  durationType: string;
  deliveryMode: 'online' | 'hybrid' | 'physical' | string;
  isCore: boolean;
  credits: number;
  status: string;
};
...
export type LearningModeRule = {
  id: number;
  programId?: string | null;
  programTitle?: string | null;
  courseId?: string | null;
  courseTitle?: string | null;
  mode: 'online' | 'hybrid' | 'physical' | string;
...
export type PracticalSession = {
  ...
  partnerInstitutionName?: string | null;
...
export type AdminAcademicStructureResponse = {
  ...
  learningModeRules: LearningModeRule[];
  venues: Venue[];
  partnerInstitutions: PartnerInstitution[];
  practicalSessions: PracticalSession[];
};

export type PlatformExpansionOverview = {
  courseOfferings: Record<string, unknown>[];
  deliveryGroups: Record<string, unknown>[];
  assessments: Record<string, unknown>[];
  gradingPolicies: Record<string, unknown>[];
  officialContentAssets: Record<string, unknown>[];
  testAnnouncements: Record<string, unknown>[];
  shortCourseCategories: Record<string, unknown>[];
  instructorApplications: Record<string, unknown>[];
  instructors: Record<string, unknown>[];
  aiUsageLogs: Record<string, unknown>[];
  contentReviewItems: Record<string, unknown>[];
};

export type PlatformOperationsOverview = {
  instructorCourseSources: Record<string, unknown>[];
  instructorAiGenerations: Record<string, unknown>[];
  courseReviewSubmissions: Record<string, unknown>[];
