...
export async function markResearchNotification(id:string){return apiFetch(`/research/notifications/${id}/read`,{method:'PATCH'});}
export async function saveResearchProfile(profile:ResearchProfile){return createResearchEntity('community','Research Profile',profile as any);}
