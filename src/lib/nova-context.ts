...
export const novaIntentPrompts: Record<string, string> = {
  ...
  hint_current_question: 'Give me a small hint for the current question without giving the full answer.',
  explain_wrong_answer: 'Explain why my answer was wrong and show the correct thinking process step by step.',
  explain_correct_answer: 'Explain why the correct answer is correct so I can remember the idea.',
  harder_question: 'Give me a harder question on the same idea. Ask one question at a time.',
  explain_code: 'Explain the current code step by step in simple language.',
  code_hint: 'Give me a small coding hint without giving the full solution.',
  debug_code: 'Help me debug my code. Start with hints and ask me what output or error I got.',
  ...
  explain_exam_result: 'Explain my Final Trial result clearly, including what the score means and what I should do next.',
  exam_improvement_plan: 'Create a practical improvement plan from my Final Trial result with the next study actions in order.',
