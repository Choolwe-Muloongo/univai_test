  ...
  return (
    <div className="min-w-0 space-y-4 overflow-hidden rounded-2xl border bg-muted/10 p-3 sm:p-4">
      <div className="min-w-0">
        ...
        <h4 className="break-words font-semibold">{isMagnetic ? 'Magnetic field visualization' : 'Electric field visualization'}</h4>
        <p className="break-words text-sm text-muted-foreground">Shows vector arrows, source object, and field-strength interpretation.</p>
      </div>
      <div className="max-w-full overflow-x-auto rounded-2xl border bg-background p-1 sm:p-2">
        <svg viewBox="0 0 900 480" className="block h-auto max-h-[70vh] w-full min-w-[320px] max-w-full" preserveAspectRatio="xMidYMid meet">
