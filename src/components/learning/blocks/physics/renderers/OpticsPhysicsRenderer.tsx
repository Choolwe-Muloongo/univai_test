...
export function OpticsPhysicsRenderer(props: Props) {
    ...
    <div className="space-y-3 rounded-2xl border bg-muted/10 p-3">
      ...
      <div className="overflow-auto rounded-2xl border bg-background p-2">
        <svg viewBox="0 0 900 460" className="h-auto w-full min-w-[640px]">
          ...
          <g className="stroke-amber-600 fill-amber-600 cursor-pointer" onClick={() => onSelect('ray-1')}>
            <line x1="220" y1="145" x2="455" y2="145" strokeWidth={highlightedIds.has('ray-1') || selectedTargetId === 'ray-1' ? 6 : 4} markerEnd="url(#optics-arrow)" />
          </g>
          <g className="stroke-amber-600 fill-amber-600 cursor-pointer" onClick={() => onSelect('ray-2')}>
            <line x1="455" y1="145" x2="690" y2="230" strokeWidth={highlightedIds.has('ray-2') || selectedTargetId === 'ray-2' ? 6 : 4} markerEnd="url(#optics-arrow)" />
          </g>
          <g className="stroke-emerald-600 fill-emerald-600 cursor-pointer" onClick={() => onSelect('ray-centre')}>
            <line x1="220" y1="145" x2="690" y2="300" strokeWidth={highlightedIds.has('ray-centre') || selectedTargetId === 'ray-centre' ? 6 : 3} markerEnd="url(#optics-arrow)" />
          </g>
