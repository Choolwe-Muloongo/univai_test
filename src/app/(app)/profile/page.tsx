...
import { badges, type Badge as BadgeType } from '@/lib/data';
...
export default function ProfilePage() {
  ...
  useEffect(() => {
    ...
    setUser(roleDetails[role] || { name: 'Student', email: 'student@univai.edu', avatar: '', school: 'UnivAI' });
    
    // Simulate fetching earned badges
