        ...
        <form onSubmit={handlePayment}>
            <CardContent className="space-y-6">
                ...
                <div className='space-y-4'>
                     ...
                     <RadioGroup defaultValue="remitsmart" className="space-y-2">
                        <Label htmlFor="remitsmart" className="flex items-center gap-4 rounded-md border p-4 has-[:checked]:border-primary">
                            <RadioGroupItem value="remitsmart" id="remitsmart" />
                            <CreditCard className="h-6 w-6" />
                            <div className="grid gap-1.5 leading-none">
                                <span className='font-semibold'>Pay with RemitSmart</span>
                                <span className='text-sm text-muted-foreground'>Card, Bank, or Mobile Money</span>
                            </div>
                        </Label>
