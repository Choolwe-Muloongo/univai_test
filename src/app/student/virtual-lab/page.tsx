    ...
    <div className="space-y-6">
      <div className="flex flex-wrap gap-3">
        <Button variant="outline" asChild>
          <Link href="/student/virtual-lab/sessions">Upcoming Sessions</Link>
        </Button>
        <Button variant="outline" asChild>
          <Link href="/student/virtual-lab/booking">Book a Lab</Link>
        </Button>
        <Button variant="outline" asChild>
          <Link href="/student/virtual-lab/history">Session History</Link>
        </Button>
      </div>
