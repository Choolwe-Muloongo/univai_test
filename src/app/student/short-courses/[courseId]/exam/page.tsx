...
import { getShortCourseCertificateUrl, getShortCourseExam, payShortCourseCertificate, paymentUrl, submitShortCourseExam, type ExamAnswer, type ShortCourseExamPayload } from '@/lib/api/short-courses';
