    ...
    <div className="space-y-6">
      <div className="flex flex-wrap gap-3">
        <Button variant="outline" asChild>
          <Link href="/student/study-plan/daily">Daily Plan</Link>
        </Button>
        <Button variant="outline" asChild>
          <Link href="/student/study-plan/weekly">Weekly Plan</Link>
        </Button>
        <Button variant="outline" asChild>
          <Link href="/student/study-plan/revisions">Revision Plan</Link>
        </Button>
      </div>
