...
class AiController extends Controller
{
    ...
    private function systemInstructionFor(string $mode, string $tier, array $policy): string
    {
        ...
        $modeInstruction = match ($mode) {
            'lesson' => 'Produce structured UnivAI lesson content in bite-sized segments (SoloLearn style): brief concept chunk, quick example, then a checkpoint question for each chunk. End every lesson with at least 25 mixed-difficulty questions (easy, medium, hard), with answer keys and rationales. Also include a recommendation to maintain a rotating bank of at least 100 lesson questions for random practice attempts.',
