...
class PlatformOperationsController extends Controller
{
    ...
    private function buildInstructorCourseDraft(array $payload, $sources): string
    {
        ...
        return implode("\n\n", [
            ...
            "Quizzes:\n- Entry diagnostic: 5 questions to place learner confidence.\n- Module checks: 5-8 questions after each module.\n- Lesson-end assessment: at least 25 questions per lesson (easy/medium/hard mix) with explanations.
- Maintain a per-lesson question bank of at least 100 items to support randomized attempts.
- Final practice quiz: 25 mixed questions with explanations and timed attempt guidance.",
